...
model.save('Linear_Regression_Keras.h5') #saving the model in binary format , h5
json_config = model.to_json() # saving the model in json format
with open('model_config.json', 'w') as json_file:
    json_file.write(json_config)
# Save weights to disk
model.save_weights('Linear_Regression_Keras_Weights.h5')
